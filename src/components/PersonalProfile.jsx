              ...
              <form onSubmit={handleSubmit}>
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginBottom: '1rem' }}>
                  <div>
                    ...
                    />
                    {errors.name && <p style={{ color: '#EF4444', fontSize: '0.875rem', margin: '0.25rem 0 0 0' }}>{errors.name}</p>}
                  </div>
                  ...
                  <div>
                    ...
                    />
                    {errors.email && <p style={{ color: '#EF4444', fontSize: '0.875rem', margin: '0.25rem 0 0 0' }}>{errors.email}</p>}
                  </div>
                </div>
